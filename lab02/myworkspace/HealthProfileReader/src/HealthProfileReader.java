...
public class HealthProfileReader {
	...
	public static String displayHealthProfile(Long personId) {
		Person p = database.get(personId);
		HealthProfile hp = p.gethProfile();
		// System.out.println(p.getFirstname() + " has a weight of " + hp.getWeight() + " Kg. and a height of " + hp.getHeight());
		return p.getFirstname() + " has a weight of " + hp.getWeight() + " Kg. and a height of " + hp.getHeight();
	}
	...
	private static void getBMI(Long personId) {
		Person p = database.get(personId);
		HealthProfile hp = p.gethProfile(); // ??????
		System.out.println(p.getFirstname() + " has bmi of: " + hp.getBMI());
	}
}