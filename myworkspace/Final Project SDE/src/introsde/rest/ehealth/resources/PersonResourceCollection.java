...
public class PersonResourceCollection {
    ...
    public ActivityResourceCollection getActivitiesPerson(@PathParam("personId") int id) {
    	return new ActivityResourceCollection(uriInfo, request, id);
    }
    
    @Path("{personId}/activity/{aid}")
    public ActivityResource getActivity(@PathParam("personId") int id, @PathParam("aid") int aid) {
    	return new ActivityResource(uriInfo, request, id, aid);
    }
    
    @Path("{personId}/goal")
    public GoalResourceCollection getGoalsPerson(@PathParam("personId") int id) {
    	return new GoalResourceCollection(uriInfo, request, id);
    }
    
    @Path("{personId}/goal/{gid}")
    public GoalResource getGoal(@PathParam("personId") int id, @PathParam("gid") int gid) {
